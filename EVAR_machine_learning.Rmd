...
=======
pacman::p_load(pacman, rio, dplyr, ggplot2, tidyverse, mice) 
>>>>>>> d626eef405d35864c1c8bf7e55918491638928a9
```
...
=======
7. Remove unnecessary or uninformative columns (e.g. primprocid)
```{r}
EVAR_preprocess$primprocid <- NULL
EVAR_preprocess$zip_postal_code <- NULL

#removing smoking quit date as I don't know how to work with this data type with ML
>>>>>>> d626eef405d35864c1c8bf7e55918491638928a9
...
Here we split to create a hold out set. Each preprocessing step will be done for both the train and test set to avoid data leakage



10. Hist visualization for numeric variables BEFORE imputation
>>>>>>> d626eef405d35864c1c8bf7e55918491638928a9
